...
class JWToken
{
    ...
    public function __construct(
        ...
        $this->domain = $container->getParameter('system_base_url');
    }
    /**
     * Generar JWToken
     *
     * @param integer $uid Identificador único de Usuario
     * @param string $username Username
     * @param integer $role rol de usuario
     ...
     * @param string $tokenCancelado token cancelado
     * @return mixed
     */
     ...
     *
     * @param string $token token de usuario logueado
     * @return mixed
     */
