...
/**
 * Class UsuariosAreaControllerTest
 * @package ApiV1Bundle\Tests\Controller
 */
class UsuariosAreaControllerTest extends ControllerTestCase
{
    /**
    ...
    public function testPostAction()
    {
        ...
        $params = [
            'nombre' => 'NombreUsuarioArea',
            'apellido' => 'ApellidoUsuarioArea',
    ...
    public function testPutAction($usuarioId)
    {
        ...
        $client->followRedirects();
        $params = [
            'nombre' => 'Nombre2UsuarioArea',
            'apellido' => 'Apellido2UsuarioArea',
            'username' => uniqid('user+') . '@gmail.com',
            'rol' => 2,
            'organismo' => 1,
            'area' => 1
