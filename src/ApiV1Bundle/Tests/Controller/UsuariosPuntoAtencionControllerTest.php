...
/**
 * Class UsuariosPuntoAtencionControllerTest
 * @package ApiV1Bundle\Tests\Controller
 */
class UsuariosPuntoAtencionControllerTest extends ControllerTestCase
{
    /**
    ...
    public function testPostAction()
    {
        ...
        $params = [
            'nombre' => 'NombreUsuarioPuntoAtencion',
            'apellido' => 'ApellidoUsuarioPuntoAtencion',
        ...
        $usuarioDatos = json_decode($client->getResponse()->getContent(), true);
    ...
    public function testPutAction($usuarioId)
    {
        ...
        $client->followRedirects();
        $params = [
            'nombre' => 'Nombre2UsuarioPuntoAtencion',
            'apellido' => 'Apellido2UsuarioPuntoAtencion',
            'username' => uniqid('user+') . '@gmail.com',
            'rol' => 2,
            'puntoatencion' => 1,
            'area' => 1
