...
/**
 * Class UsuariosOrganismoControllerTest
 * @package ApiV1Bundle\Tests\Controller
 */
class UsuariosOrganismoControllerTest extends ControllerTestCase
{
    /**
    ...
    public function testPostAction()
    {
        ...
        $params = [
            'nombre' => 'NombreUsuarioOrganismo',
            'apellido' => 'ApellidoUsuarioOrganismo',
    ...
    public function testPutAction($usuarioId)
    {
        ...
        $client->followRedirects();
        $params = [
            'nombre' => 'Nombre2UsuarioOrganismo',
            'apellido' => 'Apellido2UsuarioOrganismo',
            'username' => uniqid('user+') . '@gmail.com',
            'rol' => 2,
            'organismo' => 1
        ];
     ...
     * @param Integer usuarioId Este id corresponde al nuevo usuario creado en el método postAction
     * Annotation depends permite generar una dependencia explicita entre métodos,
     * para el caso particular entre testostAction y testDeleteAction
     *
     * @depends testPostAction
     */
